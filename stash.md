...
- 相互行為、組織、全体社会
- 一機能一システム
- 二時観察、三段階（複雑さの縮減→オートポイエーシス→二次観察）
- 社会は人間、領土などの観点でみるべきではない
- 要素自体がシステム協会★
- 要素が要素を生み出し、それが全体をつくる★
- 要素と経験的同定★
- 複製的、再帰的なメディア、意味論、システム内部の顧客、メディアの機能分化
- 経験的知識と因果★
- 社会システムの閉じた作動はコミュニケーション、他のシステムに影響は与えられない（経験的孤立を意味しない）
- 認知における開放性、閉鎖ゆえに環境に対して開かれている。環境に対しては認知できる
- 作動における閉鎖がシステムの境界を自ら生み出し再生産する。差異の確率。自己組織。作動は構造を必要とするが、構造は作動の結果である。構造は予期のこと。予期は限定のこと
- 複雑さの縮減→オートポイエーシス、コミュニケーションを算出し再生産すること。コミュニケーションは出来事で連続が必要。
- 構造カップリング
- 主体概念の否定コミュニケーションは伝達ではなく理解。
- 心理システムと社会システムの共進化
- 意味は何かについての意味
- ヒエラルキーと機能分化社会

観察の観察
区別を設けることは２つの側を生じさせる。指し示し。
再参入。常に。二時観察
